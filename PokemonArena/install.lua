...
local FILES = { "config.lua", "locations.lua", "startup.lua", "scan.lua", "teamsizes.lua", "match.lua", "ui.lua", "rename.lua", "history.lua", "update.lua", "update_full.lua", "uninstall.lua" }
...
if not os.getComputerLabel() then
    local defaultLabel = "PokemonArena_" .. os.getComputerID()
