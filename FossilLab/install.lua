...
local FILES = { "config.lua", "startup.lua", "rename.lua", "fossildata.lua", "fossilhistory.lua", "update.lua", "update_full.lua", "uninstall.lua" }
...
if not os.getComputerLabel() then
    local defaultLabel = "FossilLab_" .. os.getComputerID()
